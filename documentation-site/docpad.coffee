...
docpadConfig = {
	...
	templateData:
		...
		site:
			...
			description: """
				Documentation for the ReDBox Harvester Manager, a deployment platform for Harvester Client.
				"""
			...
			subProjectName: "Harvester Manager"
		...
		development: # Default
			...
			templateData:
				site:
					...
					project:"json-harvester-manager"
				parent:
